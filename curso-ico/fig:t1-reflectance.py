...
ax1.text(xmax/2+6,2*ymax/3,s=r"\large$L_w$",horizontalalignment='right', verticalalignment='center_baseline')
...
plt.yticks([])
plt.tight_layout()
plt.savefig("curso-ico/figs/fig:t1-reflectance.pdf")
plt.savefig("curso-ico/figs/fig:t1-reflectance.png", dpi=300)